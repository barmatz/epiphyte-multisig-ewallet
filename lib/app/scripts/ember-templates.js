 ...
 * Version 0.1.0
 * Compiled Monday, June 16th, 2014, 10:58:35 PM
 */
...
helpers = this.merge(helpers, Ember.Handlebars.helpers); data = data || {};
  ...
  },hashTypes:{'class': "STRING",'placeholder': "STRING"},hashContexts:{'class': depth0,'placeholder': depth0},contexts:[],types:[],data:data},helper ? helper.call(depth0, options) : helperMissing.call(depth0, "input", options))));
  data.buffer.push("\n                </div>\n\n                <div class=\"input-group\">\n                    <span class=\"input-group-addon\">**</span>\n                    ");
  data.buffer.push(escapeExpression((helper = helpers.input || (depth0 && depth0.input),options={hash:{
    'class': ("form-control"),
    'placeholder': ("password.."),
    'type': ("password")
  },hashTypes:{'class': "STRING",'placeholder': "STRING",'type': "STRING"},hashContexts:{'class': depth0,'placeholder': depth0,'type': depth0},contexts:[],types:[],data:data},helper ? helper.call(depth0, options) : helperMissing.call(depth0, "input", options))));
  data.buffer.push("\n                </div>\n\n                <div class=\"input-group\">\n                    <span class=\"input-group-addon\">**</span>\n                    ");
  data.buffer.push(escapeExpression((helper = helpers.input || (depth0 && depth0.input),options={hash:{
    'class': ("form-control"),
...
function program3(depth0,data) {
  ...
  data.buffer.push(escapeExpression((helper = helpers.input || (depth0 && depth0.input),options={hash:{
    ...
    'placeholder': ("id.."),
    'value': ("id")
  },hashTypes:{'class': "STRING",'placeholder': "STRING",'value': "ID"},hashContexts:{'class': depth0,'placeholder': depth0,'value': depth0},contexts:[],types:[],data:data},helper ? helper.call(depth0, options) : helperMissing.call(depth0, "input", options))));
  data.buffer.push("\n                    </div>\n                    <div class=\"input-group\">\n                        <span class=\"input-group-addon\">**</span>\n                        ");
  data.buffer.push(escapeExpression((helper = helpers.input || (depth0 && depth0.input),options={hash:{
    'class': ("form-control"),
    'placeholder': ("password.."),
    'type': ("password"),
    'value': ("password")
  },hashTypes:{'class': "STRING",'placeholder': "STRING",'type': "STRING",'value': "ID"},hashContexts:{'class': depth0,'placeholder': depth0,'type': depth0,'value': depth0},contexts:[],types:[],data:data},helper ? helper.call(depth0, options) : helperMissing.call(depth0, "input", options))));
  data.buffer.push("\n                    </div>\n                </div>\n                <div class=\"actions\">\n                    <button class=\"btn btn-primary pull-right\" type=\"submit\">Open wallet</button>\n                    \n                    ");
  stack1 = (helper = helpers['link-to'] || (depth0 && depth0['link-to']),options={hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(6, program6, data),contexts:[depth0],types:["STRING"],data:data},helper ? helper.call(depth0, "user.forgot", options) : helperMissing.call(depth0, "link-to", "user.forgot", options));
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push("\n                    ");
  stack1 = (helper = helpers['link-to'] || (depth0 && depth0['link-to']),options={hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(8, program8, data),contexts:[depth0],types:["STRING"],data:data},helper ? helper.call(depth0, "user.create", options) : helperMissing.call(depth0, "link-to", "user.create", options));
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push("\n                </div>\n            </form>\n        ");
  return buffer;
  }
